...
dove 
	...
	\]
usando come incertezza sul periodo $\delta_T = \sqrt{(\sigma_T/\sqrt{20})^2 + u_T^2} / 10$ (con $\sigma_T$ la deviazione standard del punto sperimentale più vicino al punto della retta scelto e $u_T$ l'incertezza strumentale sul periodo), e 
	\[
